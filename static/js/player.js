(function() {
	...
	var Player = Mario.Player = function(pos) {
		...
		Mario.Entity.call(this, {
			pos: pos,
			sprite: new Mario.Sprite('../static/sprites/player.png', [80,32],[16,16],0),
			hitbox: [0,0,16,16]
		});
	};
  ...
  Player.prototype.setAnimation = function() {
    ...
    if (this.jumping) {
		...
		if (this.left) {
			this.sprite.img = '../static/sprites/playerl.png';
		} else {
			this.sprite.img = '../static/sprites/player.png';
		}
  };
	...
	Player.prototype.flag = function() {
		this.noInput = true;
		this.flagging = true;
		if(LevelsJson[currentLevelIndex].introLevel==0) {
			document.getElementById("QualityFormDiv").style.visibility = "visible"
			menuActive = true;
		} else {
			currentLevelIndex++
