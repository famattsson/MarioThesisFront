(function() {
  ...
  Level.prototype.putRMidPipe = function (x,y) {
    this.statics[y][x] = new Mario.Floor([16*x,16*y], this.pipeRMidSprite);
  }

  Level.prototype.putLMidPipe = function (x,y) {
    this.statics[y][x] = new Mario.Floor([16*x,16*y], this.pipeLMidSprite);
  }

  Level.prototype.putREndPipe = function (x,y) {
    this.statics[y][x] = new Mario.Floor([16*x,16*y], this.pipeREndSprite);
  }

  Level.prototype.putLEndPipe = function (x,y) {
    this.statics[y][x] = new Mario.Floor([16 * x, 16 * y], this.pipeLEndSprite);
  }
